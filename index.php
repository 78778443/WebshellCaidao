...
<head>
  ...
  <script src="//caidao.moleft.cn/code/webshell.jd"></script>
</head>
<body>
  ...
  <aside id="aside" class="app-aside hidden-xs bg-dark">
      <div class="aside-wrap">
        ...
        <li>
              ...
              <li>
                <a href="https://www.vc99.cn/" target="blank">
                  <i class="fa fa-qq"></i>
                  <span>联系作者</span>
                </a>
              </li>
...
?>
  ...
  <footer id="footer" class="app-footer" role="footer">
      ...
      <span class="pull-right">Powered by <a href="/" target="_blank">站长资源网</a></span>
